...
public class AssemblerParser extends Parser {
    ...
    public String[] getTokenNames() {
        return AssemblerParser.tokenNames;
    }

    public String getGrammarFileName() {
        return "/Users/parrt/research/book/TPDSL/Book/code/interp/stack/Assembler.g";
    }
    ...
    public final void instr() throws RecognitionException {
        ...
        Token ID5 = null;
        Token ID6 = null;
        operand_return a = null;

        operand_return b = null;

        operand_return c = null;

        operand_return operand4 = null;

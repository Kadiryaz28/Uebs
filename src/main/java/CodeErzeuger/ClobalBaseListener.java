...
/**
 * This class provides an empty implementation of {@link ClobalListener},
 * which can be extended to create a listener which only needs to handle a subset
 * of the available methods.
 */
public class ClobalBaseListener implements ClobalListener {
    /**
     * {@inheritDoc}
     *
     ...
     */
    @Override
    public void enterFile(ClobalParser.FileContext ctx) {
    }
     ...
     */
    @Override
    public void enterBlock(ClobalParser.BlockContext ctx) {
    }
     ...
     */
    @Override
    public void enterAssignStat(ClobalParser.AssignStatContext ctx) {
    }
     ...
     */
    @Override
    public void enterForStat(ClobalParser.ForStatContext ctx) {
    }
     ...
     */
    @Override
    public void enterReturnStat(ClobalParser.ReturnStatContext ctx) {
    }
     ...
     */
    @Override
    public void enterPrintStat(ClobalParser.PrintStatContext ctx) {
    }
     ...
     */
    @Override
    public void enterVarDecl(ClobalParser.VarDeclContext ctx) {
    }
     ...
     */
    @Override
    public void enterType(ClobalParser.TypeContext ctx) {
    }
     ...
     */
    @Override
    public void exitType(ClobalParser.TypeContext ctx) {
    }
     ...
     */
    @Override
    public void enterNot(ClobalParser.NeqContext ctx) {
    }
     ...
     */
    @Override
    public void exitNot(ClobalParser.NeqContext ctx) {
    }
     ...
     */
    @Override
    public void enterIDEXPR(ClobalParser.IdExprContext ctx) {
    }
     ...
     */
    @Override
    public void enterBRACKS(ClobalParser.BracketsContext ctx) {
    }
     ...
     */
    @Override
    public void exitBRACKS(ClobalParser.BracketsContext ctx) {
    }
     ...
     */
    @Override
    public void enterMUL(ClobalParser.MultContext ctx) {
    }
     ...
     */
    @Override
    public void enterADDSUB(ClobalParser.AddSubContext ctx) {
    }
     ...
     */
    @Override
    public void enterCondOp(ClobalParser.CondOpContext ctx) {
    }
     ...
     */
    @Override
    public void exitCondOp(ClobalParser.CondOpContext ctx) {
    }
     ...
     */
    @Override
    public void enterINTEXPR(ClobalParser.IntExprContext ctx) {
    }
     ...
     */
    @Override
    public void exitIDBRACKS(ClobalParser.IdBrackContext ctx) {
    }
     ...
     */
    @Override
    public void enterCOMPARISION(ClobalParser.CompContext ctx) {
    }

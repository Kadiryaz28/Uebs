...
public class ClobalParser extends Parser {
    ...
    public static class FunctionDeclContext extends ParserRuleContext {
        ...
        public TerminalNode ID() {
            return getToken(ClobalParser.ID, 0);
        }
    ...
    public static class NeqContext extends ExprContext {
        ...
        public NeqContext(ExprContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class BracketsContext extends ExprContext {
        ...
        public BracketsContext(ExprContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class CondOpContext extends ExprContext {
        ...
        public CondOpContext(ExprContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class IntExprContext extends ExprContext {
        public TerminalNode INT() {
            return getToken(ClobalParser.INT, 0);
        }
    ...
    public static class IdBrackContext extends ExprContext {
        ...
        public IdBrackContext(ExprContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class CompContext extends ExprContext {
        ...
        public CompContext(ExprContext ctx) {
            copyFrom(ctx);
        }
